...
; GCN:      s_mov_b64 [[INNER_MASK:s\[[0-9]+:[0-9]+\]]], -1
; GCN:      s_cbranch_scc1   [[FLOW:BB[0-9]+_[0-9]+]]

; GCN: ; %bb4
; GCN:      buffer_load_dword
; GCN:      v_cmp_ge_i32_e64  [[INNER_MASK]],

; GCN: [[FLOW]]: ; %Flow
; GCN:      s_and_b64         [[INNER_MASK:s\[[0-9]+:[0-9]+\]]], exec, [[INNER_MASK]]
; GCN:      s_or_b64          [[INNER_MASK]], [[INNER_MASK]], [[OUTER_MASK]]
; GCN:      s_mov_b64         [[OUTER_MASK]], [[INNER_MASK]]
; GCN:      s_andn2_b64       exec, exec, [[INNER_MASK]]
